  ...
  return (
    <div className="chat__tool">
      ...
      <div className="about__icon">
        ...
        <div className="icon__tool">
          <img src="https://img.icons8.com/ios/50/000000/help.png" alt="icon" />
          도움말
        </div>
        </div>
      </div>
      <hr class="hrcss" align="left" width="100%" color="#EBEBEB"></hr>

      <p className="item-1"><h3>공지</h3> 3.2.2 버전 업데이트 안내</p>

<p className="item-2"><h3>Tips</h3> '컴알못'도 문제없어요~ 단축키 총정리</p>

<p className="item-3"><h3>나우</h3> 카카오톡 지갑 속 새로운 인증서</p>
    </div>
  );
}
